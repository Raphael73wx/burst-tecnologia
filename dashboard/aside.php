<aside id="asideMenu" class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo caminhoURL?>" class="brand-link">
      <img src="<?php echo caminhoURL?>/dist/img/logo-mini.png" alt="Logo" class="brand-image rounded-circle" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo caminhoURL?>/form.php" class="nav-link <?php echo $pagina_ativa == 'ordens_servicos'? 'active' : ''; ?>">
              <i class="nav-icon bi bi-box-seam text-success  mr-1 "></i>
              <p>
                  Pedidos
                <span class="right badge badge-danger"> <!--echo $total_os;--></span>
              </p>
            </a>
          </li>
